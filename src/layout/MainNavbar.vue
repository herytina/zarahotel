<template>
  ...
  <v-btn v-if="showButton" color="#ffc107" icon="arrows-1_minimal-up" bottom right
    style="position: fixed; bottom: 30px; right: 70px; z-index: 999999" size="small" @click="scrollToTop">

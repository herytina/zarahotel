<template>
    <div class="eco-responsibility-page">
        ...
        <div class="eco-commitments">
            <div class="commitment-card" v-for="(commitment, index) in commitments" :key="index">
                <div class="commitment-icon">
                    <img :src="commitment.icon" :alt="commitment.title" class="icon-image">
                </div>
...
export default {
    ...
    bodyClass: "ecoResponsibility-page",
    data() {
        return {
            commitments: [
                {
...
.hero-section {
    text-align: center;
    padding: 4rem 2rem;
    background: url('https://images.pexels.com/photos/1458457/pexels-photo-1458457.jpeg') no-repeat center center;
...
.commitment-card:hover .icon-image {
    transform: scale(1.1);
}
